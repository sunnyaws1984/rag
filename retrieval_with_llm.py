...
def answer_question(query):
    ...
    prompt = f"Based strictly on the NVIDIA context below, respond to the question.\nAvoid assumptions or information not present in the context.\n\nContext:\n{context}\n\nQuestion: {query}"
...
# 5️⃣ Gradio UI
iface = gr.Interface(
    fn=answer_question,  # <--- This is the function that handles user input
    inputs="text",  
    outputs="text",
